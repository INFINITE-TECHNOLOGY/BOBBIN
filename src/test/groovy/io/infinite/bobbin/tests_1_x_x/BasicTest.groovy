...
import io.infinite.bobbin.TestBobbinFactoryAdapter
...
class BasicTest {
    ...
    void test() {
        ...
        BobbinNameAdapter bobbinNameAdapter = new TestBobbinFactoryAdapter(getBobbinConfFileName()).getLogger(this.getClass().getCanonicalName()) as BobbinNameAdapter
